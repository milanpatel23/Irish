// Mock data for Irish Technologies Inc. website

export const mockData = {
  company: {
    name: "Irish Technologies Inc.",
    tagline: "Transforming Businesses Through Innovation",
    email: "info@i-rish.com",
    phone: "+917600240043",
    address: "Leading IT Services & Consulting Solutions"
  },
  
  hero: {
    title: "Experience the Power of Irish Technologies",
    subtitle: "Irish Technologies Inc. delivers cutting-edge IT services and consulting solutions to drive your business forward.",
    features: [
  ...
  testimonials: [
    {
      id: 1,
      text: "Irish Technologies transformed our outdated systems into a modern, efficient infrastructure. Outstanding results!",
    ...
    {
      id: 2,
      text: "Their cybersecurity expertise saved us from potential threats. Professional, reliable, and highly skilled team.",
    ...
    {
      id: 3,
      text: "The cloud migration was seamless. Irish Technologies delivered on time and within budget. Highly recommended!",
      author: "Robert Chen",
      position: "Operations Manager, CloudFirst Inc.",
      rating: 5,
